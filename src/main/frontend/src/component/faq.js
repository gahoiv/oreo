...
const gridInstance = (
  <Grid bsClass='text-center'>
    ...
    <Row className="show-grid text-normal">
      <Col sm={10} md={12} > 
      <Accordion>
  <Panel bsStyle="primary" header="I want to build a Website or overhaul my existing Web presence. Can you help?" eventKey="1">
  ...
  <Panel bsStyle="primary" header="I have an idea of what I want to build but not sure how to go about it?" eventKey="2">
  ...
  <Panel bsStyle="primary" header="Do you guys code?" eventKey="3">
  Hell-yeah! We are the best at it. Our Architects, Coders and Tech guys are the best.
  </Panel>
  <Panel bsStyle="primary" header="Why do I require Technology Consulting?" eventKey="4">
  ...
  <Panel bsStyle="primary" header="I am a Startup, how does Tech Consulting help me?" eventKey="5">
  ...
  <Panel bsStyle="primary" header="How can we start things?" eventKey="6">
