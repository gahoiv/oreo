...
const gridInstance = (
  <Grid bsClass='container text-center'>
    <Row className="show-grid footer-header">
      <Col sm={10} md={12} > <h1>Codeoreo</h1><a href="mailto:contactus@codeoreo.com" style={{color: '#000000', textDecoration: 'none', 'fontSize': '2.5rem'}}>contactus@codeoreo.com</a></Col>
    </Row>
    <Row className="footer-font">
      ...
      <Col sm={10} md={5} > <a href="mailto:contactus@codeoreo.com" style={{color: '#000000', textDecoration: 'none'}}>contactus@codeoreo.com</a></Col>
    </Row>
  </Grid>
);
